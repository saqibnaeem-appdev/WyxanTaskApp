...
import { SequenceProgress } from '@components/ui/SequenceProgress';
...
const TrackingScreen = () => {
  ...
  const [modalType, setModalType] = useState<'START' | 'END' | 'GENERAL'>(
    'GENERAL',
  );

  // Conditionals
  const canStart = React.useMemo(() => {
    if (runState !== 'IDLE' || !currentLocation || activeNode.nodeType !== 'SP')
      return false;
          ...
          <View style={styles.cardHeaderRow}>
            ...
            <View style={styles.textStack}>
              ...
              <AppText color="textSecondary" style={styles.subtitle}>
                You finished the entire patrol sequence.
              </AppText>
            </View>
          </View>
          <AppButton
        ...
        <AppCard style={styles.bottomCard}>
          ...
          <AppButton
            ...
            icon={
              <Ionicons
                name="play"
                color={canStart ? Colors.black : Colors.textMain}
                size={20}
              />
            }
        ...
        <AppCard style={styles.bottomCard}>
          <View style={styles.cardHeaderRow}>
            ...
            <View style={styles.textStack}>
              ...
              <AppText color="textMuted" style={styles.subtitle}>
                {canEnd
                  ? 'Arrived. End your run now.'
                  : 'Head to End Point to finish.'}
              </AppText>
            </View>
          </View>
          ...
          <AppButton
            ...
            icon={
              <Ionicons
                name="checkmark"
                color={canEnd ? Colors.black : Colors.textMain}
                size={20}
              />
            }
      ...
      <AppCard style={styles.bottomCard}>
        <View style={styles.cardHeaderRow}>
          ...
          <View style={styles.textStack}>
            ...
            <AppText color="textMuted" style={styles.subtitle}>
              Hit Requirement: {activeNode.targetHitIndex} of{' '}
              {activeNode.node.hits}
            </AppText>
          </View>
        </View>
        <View style={styles.instructionRow}>
          <Ionicons name="location" color={Colors.primary} size={20} />
          <AppText color="primary" style={styles.metricsText}>
            {' '}
            Proceed to the highlighted zone.
          </AppText>
        </View>
        <SequenceProgress
          sequence={sequence}
    ...
    >
      ...
      <AppHeader
        ...
        centerNode={
          <View style={styles.topHud}>
            <AppText color="primary" style={styles.hudText}>
              Status: {runState}
            </AppText>
          </View>
        }
      ...
      <AppModal visible={modalVisible} onClose={() => setModalVisible(false)}>
        <View style={styles.modalContent}>
          ...
          <AppText variant="h1" align="center" style={styles.modalTitle}>
            Out of Bounds
          </AppText>
          <AppText
            align="center"
